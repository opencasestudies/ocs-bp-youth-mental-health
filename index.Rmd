...
4) the values within the cells are in a format that is useful for making visualzations and for analysis
...
The null hypothesis is that the variables are indeed independent, or that the difference in the proportion of observed to expected frequecies is equal to zero. 
