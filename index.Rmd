...
knitr::include_graphics(here::here("www", "img", "mainplot.png"))
```
...
knitr::include_graphics(here::here("www", "img", "k-mitch-hodge-IqSaG9zv2e0-unsplash.jpg"))
```
...
knitr::include_graphics(here::here("www", "img", "depression-symptoms-and-treatment-768x768.jpg"))
```
...
knitr::include_graphics(here::here("www", "img","mortality.png"))
```
...
```{r, echo = FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","mortality_age.png"))
```
...
```{r, echo = FALSE, out.width="800px"}
knitr::include_graphics(here::here("www", "img","suicide.png"))
```
...
include_graphics(here::here("www", "img", "nsudh_screenshot_webpage.png"))
```
...
```{r, out.width = "100%", echo = FALSE, fig.align ="center"}
include_graphics(here::here("www", "img", "website_overview.png"))
```
...
```{r, echo=FALSE}
step1 <- magick::image_read(here::here("www", "img", "webpage_screenshot.png"))
step2 <- image_read(here::here("www", "img", "table_screenshot_inspect.png"))
step3 <- image_read(here::here("www", "img", "table_screenshot_inspect_table.png"))
step4 <- image_read(here::here("www", "img", "table_screenshot_inspect_table_xpath.png"))
step5 <- image_read(here::here("www", "img", "table_screenshot_xpath_copy_r.png"))
step5_zoom <- image_read(here::here("www", "img", "table_screenshot_xpath_copy_r_zoom.png"))
```
...
```{r, echo = FALSE}
knitr::include_graphics(here::here("www", "img","educational.gif"))
```
...
knitr::include_graphics(here::here("www", "img", "rvest.png"))
```
...
## **Data Wrangling**
*** 
If you stopped and want to restart the case study, or if you are starting here, you can load the data like this:
...
```{r, echo=FALSE}
load(file = here::here("www", "data", "imported", "imported_data.rda"))
```
...
```{r, echo = FALSE}
knitr::include_graphics(here::here("www", "img", "table11.1a.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(here::here("www", "img", "regex.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(here::here("www", "img", "quantifiers.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(here::here("www", "img", "dem_table.png"))
```
...
`mtcars` is a built-in R data set. 

```{r}
mtcars
```

Write some code that uses the `slice()` function of the `dplyr` package to remove the last two rows of this data set. Note: replace the underscores("_") with your code with one character per "_".

```{r dw_exercise, exercise=TRUE, eval=FALSE}
# View the data
mtcars
...
```{r, echo=FALSE}
load(file = here::here("www", "data", "wrangled", "wrangled_data.rda"))
```
...
```{r, echo=FALSE}
save(MDE_total, file =here::here("www", "plots", "MDE_total.rda"))
png(here::here("www", "plots", "MDE_total.png"))
MDE_total
dev.off()
```
...
```{r, echo=FALSE}
save(MDE_age_gender, file =here::here("www", "plots", "MDE_age_gender.rda"))
png(here::here("www", "plots", "MDE_age_gender.png"))
MDE_age_gender
dev.off()
```
...
```{r, echo=FALSE}
save(MDE_race, file =here::here("www", "plots", "MDE_race.rda"))
png(here::here("www", "plots", "MDE_race.png"))
MDE_race
dev.off()
```
...
```{r, echo=FALSE}
save(Treat_total, file =here::here("www", "plots", "Treat_total.rda"))
png(here::here("www", "plots", "Treat_total.png"))
Treat_total
dev.off()
```
...
```{r, echo = FALSE}
knitr::include_graphics(here::here("www", "img", "Chi-square_distributionCDF-English.png"))
```
...
```{r, echo=FALSE}
load(file = here::here("www", "plots", "MDE_total.rda"))
load(file = here::here("www", "plots", "Treat_total.rda"))
load(file = here::here("www", "plots", "MDE_age_gender.rda"))
load(file = here::here("www", "plots", "MDE_race.rda"))
```
...
```{r, echo = FALSE}
knitr::include_graphics(here::here("www", "img", "mainplot_orig.png"))
```
...
png(filename = here::here("www", "img", "mainplot.png"), 
         res = 300, width = 10, height = 10, units = "in")
plot_grid(title_plots, 
          forward,
          row_1,
