...
The null hypothesis is that the variables are indeed independent or that the difference in the proportions is equal to zero. 

In other words, we want to know if gender influences the number of major depressive episodes in 2004 and 2018. Or stated yet another way: _are major depressive episode counts across the two years associated with gender?_  
...
Therefore, our data suggests that gender and handedness are independent or stated another way, that gender does not influence handedness.
