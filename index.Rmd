...
readr::write_csv(percents, path = here::here("www", "data", "wrangled", "percents.csv"))
readr::write_csv(counts, path = here::here("www", "data", "wrangled", "counts.csv"))
readr::write_csv(table11.1a, path = here::here("www", "data", "wrangled", "table11.1a.csv"))
readr::write_csv(table11.1b, path = here::here("www", "data", "wrangled", "table11.1b.csv"))
```
