...
```{r}
directlabels::direct.label(MDE_age_sex, list(dl.trans(y = y +0.38, x = x -0.1), "far.from.others.borders", cex = .8, dl.move("Age_14-15", x = 2008, y =10)))
...
MDE_age_sex <-directlabels::direct.label(MDE_age_sex, list(dl.trans(y = y +0.38, x = x -0.2), "far.from.others.borders", cex = .8, dl.move("Age_14-15", x = 2008, y =10)))
MDE_age_sex
```
...
directlabels::direct.label(MDES, list(dl.trans(y = y +0.39, x = x -0.1), "far.from.others.borders", cex = .8, dl.move("Age_14-15", x= 2016.5, y = 11)))
...
treat<-directlabels::direct.label(treat, list(dl.trans(y = y -1.5, x = x -0.4), "far.from.others.borders", cex = .8, dl.move("Age_16-17", x = 2010, y = 42), dl.move("Age_14-15", x = 2015, y = 38)))
...
plotMHSS <-direct.label(plotMHSS, list(dl.trans(y = y +0.3),"far.from.others.borders", dl.move("School Therapist", 2010, 10), dl.move("Fostercare", 2010, 1), dl.move("Therapist", x=2009, y = 10.5)))
plotMHSS
```
...
# MDE_age_sex_for_mp <-directlabels::direct.label(MDE_age_sex_for_mp, list(dl.trans(y = y +0.35, x = x -0.1)))
...
MDE_race_for_mp_leg <- MDE_race +
  ...
  labs(title = "All racial/ethnic groups show similar\nincreases since 2011")+ guides(col = guide_legend(nrow = 2))
...
png(filename = here::here("img", "mainplot.png"), res = 300, width = 10, height = 10, units = "in")
...
avocado need to do this section
