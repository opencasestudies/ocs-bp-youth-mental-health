...
** NHOPI stands for Native Hawaiian or Other Pacific Islander
...
#directlabels::direct.label(MDE, list("angled.boxes", cex = .8))


```

```{r}
Age_episode <-table11.2b %>%
  filter(subgroup == "Age") %>%
  ggplot(aes(x = Year, y = Percent, group = Demographic, color = Demographic)) +
  geom_line() +
  scale_x_continuous(breaks = seq(2004, 2018, by=1),
