...
[Great resource for renaming](https://stackoverflow.com/questions/35023375/r-renaming-passed-columns-in-functions)

```{r}
data_prep <- function(TABLE, old_col, new_col, pivot_col){
...
table11.1b <- data_prep(TABLE = table11.1b,
...
table11.2a <- data_prep(TABLE = table11.2a,
...
table11.3a <- data_prep(TABLE = table11.3a,
          old_col = "Demographic Characteristic",
          new_col = "Demographic",
          pivot_col = "Number")
...
table11.4a <- data_prep(TABLE = table11.4a,
          old_col = "Demographic Characteristic",
          new_col = "Demographic",
          pivot_col = "Number")
