...
**I made some modifications to the table below. The `tidyverse` package hyperlink reference `readr`. I changed this to the tidyverse website and provided a different description.**
...
**I removed this section because the tables are relatively self-explatory.**
...
educational_gif <- image_resize(img, '1000x800!') %>%
...
**Step two**: save scraped data to an object
...
<style>
div.blue { background-color:#BBD6FF; border-radius: 5px; padding: 20px;}
</style>
<div class = "blue">

**Is there an easier way to present this process in a way that is easily digested by the audience?**

We need to balance interpretability, document length, and the raw depiction of the DS process. 

I was considering using a function. However, I am not sure this is the best approach. 

This is the function I was considering:
