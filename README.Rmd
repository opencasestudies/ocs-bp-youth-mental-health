...
<!-- badges: start -->
[![R build status](https://github.com/opencasestudies/ocs-youth-mental-health-case-study/workflows/R-CMD-check/badge.svg)](https://github.com/opencasestudies/ocs-youth-mental-health-case-study/actions)
<!-- badges: end -->
...
We will explore the rate of self-reported depression amoung american youths age 12-17 from roughly 2004 to 2018. We will also explore data about the rate at which youths that have expereinced depression symptoms are receiving mental health services. We also investigate where youths are receiving care.
